...
public class Addalumni extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_addalumni);
        ...
        sendDatabtn.setOnClickListener(v -> {
            ...
            if (TextUtils.isEmpty(name) || TextUtils.isEmpty(ph) || TextUtils.isEmpty(email) || TextUtils.isEmpty(branchup)) {
                Toast.makeText(Addalumni.this, "Please add All Fields", Toast.LENGTH_SHORT).show();
            } else {
    ...
    void addParseUnplaced(String name1, String email1, String branch1, String phone1) throws ParseException {
        ParseQuery<ParseObject> query = ParseQuery.getQuery("Alumni");
        ParseObject entity = new ParseObject("Alumni");
