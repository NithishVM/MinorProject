...
public class Addplaced extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_addplaced);
        ...
        databaseReference = firebaseDatabase.getReference("PlacedStudentData");
        ...
        sendDatabtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(name) && TextUtils.isEmpty(ph) && TextUtils.isEmpty(email) && TextUtils.isEmpty(branchup)) {
                    Toast.makeText(Addplaced.this, "Please add some data.", Toast.LENGTH_SHORT).show();
                } else {
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (name1.isEmpty() || phone1.isEmpty() || branch1.isEmpty() || email1.isEmpty()) {
                    ...
                    Toast.makeText(com.example.placementapp.Addplaced.this, "Placed Student added to Database", Toast.LENGTH_SHORT).show();

                }
            }
            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(com.example.placementapp.Addplaced.this, "Fail to add data " + error, Toast.LENGTH_SHORT).show();
            }
        });
    }
}